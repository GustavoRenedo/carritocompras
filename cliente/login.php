...
if (isset($_SESSION["cliente"])) {
    ...
    if ($opcionesCliente->login($_POST)) {
        header("Location: /");
    } else {
      ...
      <div class="login-container">
          <div class="login-info-container">
            ...
            <form value="#">
                ...
                <div class="mb-4 form-check boton-aceptar">
                    <input type="checkbox" name="connected" class="form-check-input" required>
                    <label for="connected" class=" form-check-label">Acepto los <a href="../terminos_condiciones.php"> terminos y condiciones</a></label>
                </div>
                ...
                <span class="boton-aceptar">¿No tienes cuenta? <a href="registro.php" class="fw-bold  text-dark">Registrate</a></span>
